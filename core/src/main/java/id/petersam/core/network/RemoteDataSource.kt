package id.petersam.core.network

import com.squareup.moshi.Moshi
import id.petersam.core.vo.HttpResult
...
open class RemoteDataSource {
    open suspend fun <T> safeApiCall(dispatcher: CoroutineDispatcher, apiCall: suspend () -> T): RemoteResult<T> {
